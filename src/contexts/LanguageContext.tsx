...
const translations = {
  en: {
    ...
    'auth.signup.subtitle': 'Start your real estate journey',
  ...
  de: {
    ...
    'auth.signup.subtitle': 'Starten Sie Ihre Immobilienreise',
    ...
    'auth.logging': 'Wird angemeldet...',
    'auth.creating': 'Konto wird erstellt...',
    'auth.agreeToTerms': 'Ich stimme den',
    'auth.termsAndConditions': 'Allgemeinen Geschäftsbedingungen zu',
  }
};
